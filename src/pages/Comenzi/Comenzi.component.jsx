...
const override =`
  ...
  border-color: red;
`
export default function Comenzi(props) {
  const tblHeaderKeys = ["nr. crt.", "data", "nr. inmatriculare", "km", "partener", "cost partener", "flota", "cost flota"]
  ...
  if(ordersDisplayData.length) {
    ordersDisplayData.forEach(el => {
      totalOrderCostPartner +=parseFloat(el.order_total)
    ...
    <div className="dashboard">
      ...
      <div className="workspace">
        ...
        {!props.showSpinner ? 
          ...
          />
          <TableTitle 
            text={`TOTAL Cost Flote: ${totalOrderCostFleet.toFixed(2)} Lei`}          
            dataSet={[]}
          />
          </>
        :         
