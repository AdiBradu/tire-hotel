...
export default function TireDetailsMultipleSets(props) { 
  const tiresFilterInfo = [4, 6]
  const tireSetsFilterInfo = [1,2]
  let heightOpts = []
  ...
  return (
    <div className="vehicle-wrapper">
      ...
      <div className="filter-tab active">          
          <Filter name={'Seturi anvelope'} onFilterChange={props.handleTiresSetsChange} filterInfo={tireSetsFilterInfo} currentFilter={props.multipleTireSets} />
      </div>
      </>
      :
      null
      ...
      {props.vehicleTireSetsCount > 1 ?
      <div className="vehicle-tires">    
        <div className="tire-details">
          <p>Detalii anvelope depozitate</p>

          <div className="tires-wrapper">
            <div className="tire-layout">
              <SectionSubTitle text="" data="" name={"Fata/Dreapta"}/>
              <div className="tire-row">
                <SelectField onChange={props.onHotelChange} name="widths_0" value={props.hData.vehicleTires?.widths[0]} fieldOptions={widthOpts} label="latime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="heights_0" value={props.hData.vehicleTires?.heights[0]} fieldOptions={heightOpts} label="inaltime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="diameters_0" value={props.hData.vehicleTires?.diameters[0]} fieldOptions={diameterOpts} label="diametru" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="speedIndexes_0" value={props.hData.vehicleTires?.speedIndexes[0]} fieldOptions={speedIndexesOpts} label="ind. viteza" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="loadIndexes_0" value={props.hData.vehicleTires?.loadIndexes[0]} fieldOptions={loadIndexesOpts} label="ind. sarcina" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="brands_0" value={props.hData.vehicleTires?.brands[0]} fieldOptions={brandOpts} label="brand" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <InputField onChange={props.onHotelChange}  name="models_0" value={props.hData.vehicleTires?.models[0]} type="text" label="model" width="180px" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
                <SelectField onChange={props.onHotelChange} name="seasons_0" value={props.hData.vehicleTires?.seasons[0]} fieldOptions={seasonOpts} optTextEqualsValue={true} label="sezon" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <InputField onChange={props.onHotelChange}  name="dots_0" value={props.hData.vehicleTires?.dots[0]}  width="70px" type="text" label="DOT" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
                <SelectField onChange={props.onHotelChange} name="rims_0" value={props.hData.vehicleTires?.rims[0]} fieldOptions={rimOpts} label="janta" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="treadUsages_0" value={props.hData.vehicleTires?.treadUsages[0]} fieldOptions={treadUsageOpts} optTextEqualsValue={true} label="uzura" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="hotelId_0" value={props.hData.vehicleTires?.hotelId[0]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              </div>
            </div>
            ...
            <div className="tire-layout">
              <SectionSubTitle text="" data="" name={"Fata/Stanga"}/>
              <div className="tire-row">
                <SelectField onChange={props.onHotelChange} name="widths_1" value={props.hData.vehicleTires?.widths[1]} fieldOptions={widthOpts} label="latime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="heights_1" value={props.hData.vehicleTires?.heights[1]} fieldOptions={heightOpts} label="inaltime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="diameters_1" value={props.hData.vehicleTires?.diameters[1]} fieldOptions={diameterOpts} label="diametru" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="speedIndexes_1" value={props.hData.vehicleTires?.speedIndexes[1]} fieldOptions={speedIndexesOpts} label="ind. viteza" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="loadIndexes_1" value={props.hData.vehicleTires?.loadIndexes[1]} fieldOptions={loadIndexesOpts} label="ind. sarcina" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="brands_1" value={props.hData.vehicleTires?.brands[1]} fieldOptions={brandOpts} label="brand" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <InputField onChange={props.onHotelChange}  name="models_1" value={props.hData.vehicleTires?.models[1]} type="text" label="model" width="180px" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
                <SelectField onChange={props.onHotelChange} name="seasons_1" value={props.hData.vehicleTires?.seasons[1]} fieldOptions={seasonOpts} optTextEqualsValue={true} label="sezon" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <InputField onChange={props.onHotelChange}  name="dots_1" value={props.hData.vehicleTires?.dots[1]}  width="70px" type="text" label="DOT" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
                <SelectField onChange={props.onHotelChange} name="rims_1" value={props.hData.vehicleTires?.rims[1]} fieldOptions={rimOpts} label="janta" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="treadUsages_1" value={props.hData.vehicleTires?.treadUsages[1]} fieldOptions={treadUsageOpts} optTextEqualsValue={true} label="uzura" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="hotelId_1" value={props.hData.vehicleTires?.hotelId[1]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              </div>
            </div>
            ...
            <div className="tire-layout">
              <SectionSubTitle text="" data="" name={"Spate/Dreapta"}/>
              <div className="tire-row">
                <SelectField onChange={props.onHotelChange} name="widths_2" value={props.hData.vehicleTires?.widths[2]} fieldOptions={widthOpts} label="latime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="heights_2" value={props.hData.vehicleTires?.heights[2]} fieldOptions={heightOpts} label="inaltime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="diameters_2" value={props.hData.vehicleTires?.diameters[2]} fieldOptions={diameterOpts} label="diametru" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="speedIndexes_2" value={props.hData.vehicleTires?.speedIndexes[2]} fieldOptions={speedIndexesOpts} label="ind. viteza" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="loadIndexes_2" value={props.hData.vehicleTires?.loadIndexes[2]} fieldOptions={loadIndexesOpts} label="ind. sarcina" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="brands_2" value={props.hData.vehicleTires?.brands[2]} fieldOptions={brandOpts} label="brand" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <InputField onChange={props.onHotelChange}  name="models_2" value={props.hData.vehicleTires?.models[2]} type="text" label="model" width="180px" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
                <SelectField onChange={props.onHotelChange} name="seasons_2" value={props.hData.vehicleTires?.seasons[2]} fieldOptions={seasonOpts} optTextEqualsValue={true} label="sezon" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <InputField onChange={props.onHotelChange}  name="dots_2" value={props.hData.vehicleTires?.dots[2]}  width="70px" type="text" label="DOT" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
                <SelectField onChange={props.onHotelChange} name="rims_2" value={props.hData.vehicleTires?.rims[2]} fieldOptions={rimOpts} label="janta" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="treadUsages_2" value={props.hData.vehicleTires?.treadUsages[2]} fieldOptions={treadUsageOpts} optTextEqualsValue={true} label="uzura" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="hotelId_2" value={props.hData.vehicleTires?.hotelId[2]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              </div>
            </div>
            ...
            <div className="tire-layout">
              <SectionSubTitle text="" data="" name={"Spate/Stanga"}/>
              <div className="tire-row">
                <SelectField onChange={props.onHotelChange} name="widths_3" value={props.hData.vehicleTires?.widths[3]} fieldOptions={widthOpts} label="latime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="heights_3" value={props.hData.vehicleTires?.heights[3]} fieldOptions={heightOpts} label="inaltime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="diameters_3" value={props.hData.vehicleTires?.diameters[3]} fieldOptions={diameterOpts} label="diametru" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="speedIndexes_3" value={props.hData.vehicleTires?.speedIndexes[3]} fieldOptions={speedIndexesOpts} label="ind. viteza" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="loadIndexes_3" value={props.hData.vehicleTires?.loadIndexes[3]} fieldOptions={loadIndexesOpts} label="ind. sarcina" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="brands_3" value={props.hData.vehicleTires?.brands[3]} fieldOptions={brandOpts} label="brand" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <InputField onChange={props.onHotelChange}  name="models_3" value={props.hData.vehicleTires?.models[3]} type="text" label="model" width="180px" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
                <SelectField onChange={props.onHotelChange} name="seasons_3" value={props.hData.vehicleTires?.seasons[3]} fieldOptions={seasonOpts} optTextEqualsValue={true} label="sezon" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <InputField onChange={props.onHotelChange}  name="dots_3" value={props.hData.vehicleTires?.dots[3]}  width="70px" type="text" label="DOT" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
                <SelectField onChange={props.onHotelChange} name="rims_3" value={props.hData.vehicleTires?.rims[3]} fieldOptions={rimOpts} label="janta" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="treadUsages_3" value={props.hData.vehicleTires?.treadUsages[3]} fieldOptions={treadUsageOpts} optTextEqualsValue={true} label="uzura" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="hotelId_3" value={props.hData.vehicleTires?.hotelId[3]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              </div>
            </div>
            ...
            <div className="tire-layout">
              ...
              {props.vehicleTireCount > 4 &&
              <div className="tire-row">
                <SelectField onChange={props.onHotelChange} name="widths_4" value={props.hData.vehicleTires?.widths[4]} fieldOptions={widthOpts} label="latime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="heights_4" value={props.hData.vehicleTires?.heights[4]} fieldOptions={heightOpts} label="inaltime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="diameters_4" value={props.hData.vehicleTires?.diameters[4]} fieldOptions={diameterOpts} label="diametru" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="speedIndexes_4" value={props.hData.vehicleTires?.speedIndexes[4]} fieldOptions={speedIndexesOpts} label="ind. viteza" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="loadIndexes_4" value={props.hData.vehicleTires?.loadIndexes[4]} fieldOptions={loadIndexesOpts} label="ind. sarcina" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="brands_4" value={props.hData.vehicleTires?.brands[4]} fieldOptions={brandOpts} label="brand" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <InputField onChange={props.onHotelChange}  name="models_4" value={props.hData.vehicleTires?.models[4]} type="text" label="model" width="180px" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
                <SelectField onChange={props.onHotelChange} name="seasons_4" value={props.hData.vehicleTires?.seasons[4]} fieldOptions={seasonOpts} optTextEqualsValue={true} label="sezon" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <InputField onChange={props.onHotelChange}  name="dots_4" value={props.hData.vehicleTires?.dots[4]}  width="70px" type="text" label="DOT" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
                <SelectField onChange={props.onHotelChange} name="rims_4" value={props.hData.vehicleTires?.rims[4]} fieldOptions={rimOpts} label="janta" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="treadUsages_4" value={props.hData.vehicleTires?.treadUsages[4]} fieldOptions={treadUsageOpts} optTextEqualsValue={true} label="uzura" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
                <SelectField onChange={props.onHotelChange} name="hotelId_4" value={props.hData.vehicleTires?.hotelId[4]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              </div>
              }
            </div>
            ...
            {props.vehicleTireCount > 4 &&
            <div className="tire-row">
              <SelectField onChange={props.onHotelChange} name="widths_5" value={props.hData.vehicleTires?.widths[5]} fieldOptions={widthOpts} label="latime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              <SelectField onChange={props.onHotelChange} name="heights_5" value={props.hData.vehicleTires?.heights[5]} fieldOptions={heightOpts} label="inaltime" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              <SelectField onChange={props.onHotelChange} name="diameters_5" value={props.hData.vehicleTires?.diameters[5]} fieldOptions={diameterOpts} label="diametru" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              <SelectField onChange={props.onHotelChange} name="speedIndexes_5" value={props.hData.vehicleTires?.speedIndexes[5]} fieldOptions={speedIndexesOpts} label="ind. viteza" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              <SelectField onChange={props.onHotelChange} name="loadIndexes_5" value={props.hData.vehicleTires?.loadIndexes[5]} fieldOptions={loadIndexesOpts} label="ind. sarcina" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              <SelectField onChange={props.onHotelChange} name="brands_5" value={props.hData.vehicleTires?.brands[5]} fieldOptions={brandOpts} label="brand" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              <InputField onChange={props.onHotelChange}  name="models_5" value={props.hData.vehicleTires?.models[5]} type="text" label="model" width="180px" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
              <SelectField onChange={props.onHotelChange} name="seasons_5" value={props.hData.vehicleTires?.seasons[5]} fieldOptions={seasonOpts} optTextEqualsValue={true} label="sezon" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              <InputField onChange={props.onHotelChange}  name="dots_5" value={props.hData.vehicleTires?.dots[5]}  width="70px" type="text" label="DOT" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
              <SelectField onChange={props.onHotelChange} name="rims_5" value={props.hData.vehicleTires?.rims[5]} fieldOptions={rimOpts} label="janta" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              <SelectField onChange={props.onHotelChange} name="treadUsages_5" value={props.hData.vehicleTires?.treadUsages[5]} fieldOptions={treadUsageOpts} optTextEqualsValue={true} label="uzura" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              <SelectField onChange={props.onHotelChange} name="hotelId_5" value={props.hData.vehicleTires?.hotelId[5]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
            </div>}
          </div>
          </div>
        </div>
