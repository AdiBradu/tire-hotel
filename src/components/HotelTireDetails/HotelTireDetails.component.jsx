...
import './HotelTireDetails.component.scss'
...
export default function HotelTireDetails(props) { 
          ...
          <div className="tires-wrapper">
            <div className="tire-layout">
              ...
              <div className="tire-row">
                ...
                <SelectField onChange={props.onChange} name="hotelId_0" value={props.vData.vehicleTires?.hotelId[0]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              </div>
            </div>
            ...
            <div className="tire-layout">
              ...
              <div className="tire-row">
                ...
                <SelectField onChange={props.onChange} name="hotelId_1" value={props.vData.vehicleTires?.hotelId[1]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              </div>
            </div>
            ...
            <div className="tire-layout">
              ...
              <div className="tire-row">
                ...
                <SelectField onChange={props.onChange} name="hotelId_2" value={props.vData.vehicleTires?.hotelId[2]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              </div>
            </div>
            ...
            <div className="tire-layout">
              ...
              <div className="tire-row">
                ...
                <SelectField onChange={props.onChange} name="hotelId_3" value={props.vData.vehicleTires?.hotelId[3]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              </div>
            </div>
            ...
            <div className="tire-layout">
              ...
              <div className="tire-row">
                ...
                <SelectField onChange={props.onChange} name="hotelId_4" value={props.vData.vehicleTires?.hotelId[4]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
              </div>
              }
            </div>
            ...
            <div className="tire-row">
              ...
              <SelectField onChange={props.onChange} name="hotelId_5" value={props.vData.vehicleTires?.hotelId[5]} fieldOptions={hList} customValue={true} label="hotel" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'} />
            </div>}
          </div>
          </div>
        </div>
