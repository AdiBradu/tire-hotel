...
export default function FleetDetails(props) {
    return (
        <div className="fleet-details">
            ...
            <InputField onChange={props.onChange} name="fleet_region" value={props.uDets.fleet_region} type="text" label="judet" color={'#1D3557'} inputBackground={'#FFD185'} labelColor={'#1D3557'}/>
